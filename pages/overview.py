...
# Register a custom plotly template that forces dark text everywhere
import plotly.io as pio
import plotly.graph_objects as go

pio.templates["land_finder"] = go.layout.Template(
    layout=go.Layout(
        font=dict(color="#0f172a", family="Arial", size=12),
        title=dict(font=dict(color="#0f172a", size=14, family="Arial")),
        xaxis=dict(
            tickfont=dict(color="#0f172a", size=11),
            titlefont=dict(color="#0f172a", size=12),
            gridcolor="#f1f5f9",
            linecolor="#e2e8f0",
        ...
        plot_bgcolor="#ffffff",
        colorway=["#3b82f6", "#f97316", "#22c55e", "#dc2626", "#9333ea"],
    )
)
pio.templates.default = "land_finder"
MID   = "#475569"
LIGHT = "#f1f5f9"
WHITE = "#ffffff"
