...
def build_map(
    ...
    # Map tile names that work with folium 0.20+
    tile_map = {
        "cartodbpositron":   ("cartodbpositron",   "© CartoDB"),
        "cartodbdark_matter":("cartodbdark_matter", "© CartoDB"),
        "openstreetmap":     ("openstreetmap",      "© OpenStreetMap contributors"),
    }
    tile_name, tile_attr = tile_map.get(tiles, ("cartodbpositron", "© CartoDB"))
    m = folium.Map(location=center, zoom_start=zoom, tiles=tile_name, attr=tile_attr)
